...
void kernel_config_set_socket_dispatch_cpu(t_kernel_config*, int socketDispatch);
void kernel_config_set_socket_interrupt_cpu(t_kernel_config*, int socketInterrupt);
